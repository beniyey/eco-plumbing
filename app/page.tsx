  ...
  return (
    <div className="m-auto">
      ...
      <div className="py-40 relative">
        ...
        <span className="absolute border-8 border-secondary-text w-40 h-40 block rounded-full top-16 right-20 -z-10 duration1" />
        <span className="absolute border-8 border-secondary-text w-32 h-32 block rounded-full top-80 left-24 -z-10 duration1" />
        <span className="absolute border-8 border-white w-40 h-40 block rounded-full top-[450px] right-24  duration1" />
      </div>
      ...
      <div className="w-full bg-white">
        <div className=" flex flex-row justify-center container">
          ...
          <div className="w-1/2 flex flex-col justify-center items-center gap-6">
            <span className="flex flex-row gap-10 border-4 border-background-primary-light w-4/5 py-5 px-10 items-center justify-between rounded-xl">
