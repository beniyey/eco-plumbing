...
export const serviceLandings: Record<string, ServiceLandingConfig> = {
  ...
  plumbing: {
    ...
    heroImage: "/images/plumbing-service.png",
    hero: {
      title: "צריך אינסטלטור מקצועי?",
      titleHighlight: "אנחנו בדרך",
      subtitle:
        "שירותי אינסטלציה לבית ולעסק — התקנות, תיקונים, תחזוקה ומענה מהיר עם ציוד מתקדם.",
    },
    problemsSection: {
      title: "כל עבודת אינסטלציה במקום אחד",
      subtitle: "מברז דולף ועד התקנה מלאה — שירות מקצועי, שקוף ואמין.",
    },
    problems: [
      { title: "התקנת כלים סניטריים", icon: "wrench", desc: "כיורים, אסלות, מקלחות וברזים." },
      { title: "תיקון ברז או כיור", icon: "droplets", desc: "תיקון מהיר ונקי." },
      { title: "דוד שמש / דוד חשמלי", icon: "alert", desc: "התקנה ותיקון." },
      { title: "לחץ מים נמוך", icon: "slow", desc: "אבחון ופתרון." },
      { title: "תחזוקה שוטפת", icon: "refresh", desc: "מניעת תקלות לפני שהן מחמירות." },
      { title: "תקלה דחופה", icon: "zap", desc: "זמינות מהירה באזור השרון והמרכז." },
    ],
    whyUs: DEFAULT_WHY_US,
    processSteps: DEFAULT_PROCESS,
    gallery: baseGallery("/images/plumbing-service.png", [{ src: "/images/plumber.webp", alt: "אינסטלטור", label: "שירות מקצועי" }]),
    faq: [
      { title: "אילו שירותים אתם מספקים?", content: "התקנות, תיקונים, דודים, צנרת, סתימות ואיתור נזילות." },
      { title: "יש מחירון?", content: "הצעת מחיר לפי סוג העבודה — שקוף לפני ביצוע." },
      { title: "זמינות בשבת?", content: "שירות חירום לפי צורך — התקשרו לפרטים." },
      { title: "באילו אזורים?", content: "השרון והמרכז." },
    ],
    finalCta: { title: "צריך אינסטלטור עכשיו?", subtitle: "התקשרו או שלחו WhatsApp — נחזור אליכם במהירות." },
    meta: {
      title: "אינסטלטור {city} | שירותי אינסטלציה | אקו אינסטלציה",
      description: "אינסטלטור מקצועי ב{city}. התקנות, תיקונים וחירום. {phone}",
      ogImage: "/images/plumbing-service.png",
    },
  },
};
